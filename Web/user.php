		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Monitoring Region</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div  style="overflow: scroll; text-align: center;overflow:hidden;">
                                    <br>
                                    <center>
                                    <img src='img/userlogo.png' style=";border-radius: 120px; border: 5px solid black">
                                    <br><br>
                                    <div class="well" style="width: 60%;font-size: 20px"><?php echo $Address; ?></div>
                                    <div class="well" style="width: 60%;"> <h5><?php echo $Telephone; ?></h5> </div>
                                    </center>
                                </div>
                            </div>
                    </div>
